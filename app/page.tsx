            ...
            <section className="section section-hero">
                <div className="hero-layout">
                    <div className="hero-text">
                        ...
                        <h1 className="hero-title">Contracts, slices, and calm releases.</h1>
                        <p className="hero-lead">
                            I help product teams ship thin vertical slices that match real data,
                            not guesses. Contract first, clear quality checks, and UI that fits
                    ...
                    <div className="hero-card">
                        ...
                        <p className="hero-card-note">
                            Best fit: product teams in EU time zones that care about contracts,
                ...
                <div className="card-grid">
                    <article className="card">
                        ...
                        <p className="card-body-text">
                            ...
                            customers, projects, and assets with a typed contract and a thin UI
                            on top.
                        </p>
                    ...
                    <article className="card">
                        ...
                        <p className="card-body-text">
                            Next.js app that shows how I handle data fetching, caching, loading
                            states, and error paths with SWR and a clear quality setup.
                        </p>
                        <div className="card-tag-row">
                        ...
                        <div className="how-item">
                            ...
                            <div className="how-content">
                                ...
                                <p className="how-text">
                                    ...
                                    Generate types, mock early, and keep a simple contract check in
                                    CI.
                                </p>
                            </div>
                        </div>
